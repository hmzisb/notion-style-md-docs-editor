...
- Current task: P3-T04
- Open at Gate 3: `./shell` measures 104.11 kB gz against the 60 kB budget in docs/02 section 7, capped at 105 kB; P2-T11 cut the palette into its own lazy chunk, the toaster and the Radix menu stack are what is left, and P3's row menus share it (DEV-012, ASM-063).
