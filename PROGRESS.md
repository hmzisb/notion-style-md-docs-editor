...
- Current task: P2-T14
- For P2-T14: an uploaded image is a relative path (`![](assets/flow-diagram.png)`), which the round-trip fixture should carry - it is the one link shape the editor writes by itself.
