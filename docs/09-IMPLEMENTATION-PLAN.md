...
Verify: `pnpm --filter @docs/core test` · `pnpm contract:gen && git diff --exit-code contract/openapi.json`
...
Verify: `pnpm --filter @docs/core test ids hash`
...
Verify: `pnpm --filter @docs/core test tree`
...
Verify: `pnpm --filter @docs/core test frontmatter`
...
Verify: `pnpm --filter @docs/core test paths ordering`
...
Verify: `pnpm --filter @docs/core test links`
...
Verify: `pnpm --filter @docs/core test corpus` (loads without error, counts match a manifest)
...
Verify: `pnpm --filter @docs/core test walk memory-store`
...
Verify: `pnpm --filter @docs/core test provider-read`
...
Verify: `pnpm --filter @docs/core test provider-write`
...
Verify: `pnpm --filter @docs/core test conformance`
...
Verify: `pnpm --filter @docs/core test codec`
...
Verify: `pnpm --filter @docs/core test fidelity && pnpm doctor fixtures/corpus --allow-lossy`
...
Verify: `pnpm --filter @docs/react build` produces every entry and both CSS files; `publint` and `attw` pass.
...
Verify: `pnpm --filter @docs/react test provider queries`
...
Verify: `pnpm --filter @docs/react test cache`
...
Verify: `pnpm --filter @docs/react test sidebar-store recents`
...
Verify: `pnpm --filter @docs/react test tree`
...
Verify: `pnpm --filter @docs/react test view`; `size-limit` for `./tree` + `./view` ≤ 80 KB gz excluding peers.
...
Verify: `pnpm --filter @docs/react test filesystem`
...
Verify: `pnpm --filter @docs/react test http`
...
Verify: `pnpm --filter @docs/react test editor`; `size-limit` for `./editor` ≤ 260 KB gz excluding peers (record the number; if above, log a deviation with the breakdown).
...
Verify: `pnpm --filter @docs/react test session drafts`
...
Verify: `pnpm --filter @docs/react test offline`; e2e `offline.spec.ts`.
...
Verify: `pnpm --filter @docs/core test rules-callout`; e2e block golden extended.
...
Verify: `pnpm --filter @docs/core test rules-toggle`.
...
Verify: `pnpm --filter @docs/core test rules-caption`.
...
Verify: `pnpm --filter @docs/react test upload`; e2e `upload.spec.ts` in OPFS mode.
...
Verify: `pnpm --filter @docs/react test audit`.
