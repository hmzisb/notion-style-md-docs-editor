...
/**
 * shadcn `context-menu`, trimmed to the parts the block menu uses (docs/05 section 2) and
 * styled from `ui/dropdown-menu`, so a right-click menu and a `⋯` menu are the same object.
 */
