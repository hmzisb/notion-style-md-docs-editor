...
export const defaultStrings = {
  ...
  'dialog.compare.title': 'Compare with the file',
  'dialog.compare.description': 'The file on the left, your unsaved draft on the right.',
  'dialog.compare.file': 'File',
  'dialog.compare.draft': 'Your draft',
  'dialog.compare.same': 'The two are identical.',
  'dialog.compare.close': 'Done',
  ...
  // One name per block, shared by the slash menu and Turn into; the descriptions are the
  // slash menu's second line (docs/06 section 8).
  'editor.block.p': 'Text',
  'editor.block.h1': 'Heading 1',
  'editor.block.h2': 'Heading 2',
  'editor.block.h3': 'Heading 3',
  'editor.block.blockquote': 'Blockquote',
  'editor.block.hr': 'Divider',
  'editor.block.ul': 'Bulleted list',
  'editor.block.ol': 'Numbered list',
  'editor.block.listTodo': 'To-do list',
  'editor.block.toggle': 'Toggle',
  'editor.block.img': 'Image',
  'editor.block.codeBlock': 'Code block',
  'editor.block.callout': 'Callout',
  'editor.block.table': 'Table',
  'editor.block.link': 'Link',
  'editor.block.page': 'Page',
  'editor.blockDesc.p': 'Plain paragraph',
  'editor.blockDesc.h1': 'Big section heading',
  'editor.blockDesc.h2': 'Medium section heading',
  'editor.blockDesc.h3': 'Small section heading',
  'editor.blockDesc.blockquote': 'Set text apart as a quote',
  'editor.blockDesc.hr': 'A line between blocks',
  'editor.blockDesc.ul': 'A simple bulleted list',
  'editor.blockDesc.ol': 'A list with numbering',
  'editor.blockDesc.listTodo': 'Track tasks with checkboxes',
  'editor.blockDesc.toggle': 'Hide blocks inside a toggle',
  'editor.blockDesc.img': 'Add one by URL or path',
  'editor.blockDesc.codeBlock': 'Code with highlighting',
  'editor.blockDesc.callout': 'Highlight a note or a warning',
  'editor.blockDesc.table': 'Rows and columns of cells',
  'editor.blockDesc.link': 'Link to a page or a URL',
  'editor.blockDesc.page': 'Add a page inside this one',
  'editor.callout.variant': 'Callout style',
  'editor.callout.note': 'Note',
  'editor.callout.tip': 'Tip',
  'editor.callout.important': 'Important',
  ...
  'editor.image.upload': 'Upload',
  'editor.image.uploading': 'Uploading {name}…',
  'editor.image.uploadFailed': 'That file could not be uploaded. Try again, or paste a URL.',
  'editor.code.format': 'Format code',
  'editor.code.language': 'Search language',
  'editor.code.noLanguage': 'No language found',
  'editor.code.copy': 'Copy code',
  'editor.link.edit': 'Edit link',
  'editor.link.text': 'Text to display',
  'editor.link.open': 'Open link in a new tab',
  'editor.table.borders': 'Cell borders',
  'editor.table.deleteTable': 'Delete table',
  'editor.table.mergeCells': 'Merge cells',
  'editor.table.splitCell': 'Split cell',
  'editor.table.insertRowBefore': 'Insert row before',
  'editor.table.insertRowAfter': 'Insert row after',
  'editor.table.deleteRow': 'Delete row',
  'editor.table.insertColumnBefore': 'Insert column before',
  'editor.table.insertColumnAfter': 'Insert column after',
  'editor.table.deleteColumn': 'Delete column',
  'editor.table.borderTop': 'Top border',
  'editor.table.borderRight': 'Right border',
  'editor.table.borderBottom': 'Bottom border',
  'editor.table.borderLeft': 'Left border',
  'editor.table.borderNone': 'No border',
  'editor.table.borderOutside': 'Outside borders',
  'editor.blockMenu.label': 'Block actions',
  'editor.blockMenu.duplicate': 'Duplicate',
  'editor.blockMenu.copy': 'Copy',
  'editor.blockMenu.copied': 'Copied blocks',
